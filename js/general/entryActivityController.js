angular.module('entryActivity', ['ui.router', 'ui.dateTimeInput', 'ui.bootstrap.datetimepicker'])

.controller('entryActivityController', ['$scope', '$http','$stateParams', '$filter', function($scope, $http, $stateParams, $filter) {
  $scope.activityTitle = "";
